    ...
    *,
    ...
    if context.sourceModel is not None and context.fragment.id:
        ...
        if isinstance(approval, dict):
            ...
            control_facts = control_flow_proof_facts_from_source_model(
            ...
            fence_facts = fence_proof_facts_from_source_model(
                context.fragment.id, context.sourceModel, approval,
            )
...
def _translate_phase6_proof_pipeline(
    *,
    ...
    if not candidate_plans:
        rejected_attempts.append(TargetLoweringAttempt(
            plan_id="phase6b.global-gate",
            stage="phase6b",
            reason_codes=(candidate_generation_blockers(source_model) or
                          ("phase6b.no-candidate-family",)),
        ))
